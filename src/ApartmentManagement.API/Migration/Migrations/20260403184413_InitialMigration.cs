        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferenceApartmentId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ReferenceInvoiceId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ParentFeedbackId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Feedbacks_Apartments_ReferenceApartmentId",
                        column: x => x.ReferenceApartmentId,
                        principalTable: "Apartments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Feedbacks_Invoices_ReferenceInvoiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UtilityServiceId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InvoiceDetails_UtilityServices_UtilityServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Feedbacks_Path",
                table: "Feedbacks",
                column: "Path",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Feedbacks_ReferenceApartmentId",
                table: "Feedbacks",
                column: "ReferenceApartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Feedbacks_ReferenceInvoiceId",
                table: "Feedbacks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceDetails_InvoiceId_UtilityServiceId",
                table: "InvoiceDetails",
                columns: new[] { "InvoiceId", "UtilityServiceId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceDetails_UtilityServiceId",
                table: "InvoiceDetails",
                column: "UtilityServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_Invoices_ApartmentId_BillingMonth",
                table: "Invoices",
                columns: new[] { "ApartmentId", "BillingMonth" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Residents_ApartmentId_PhoneNumber",
                table: "Residents",
                columns: new[] { "ApartmentId", "PhoneNumber" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UtilityServices_ServiceName",
